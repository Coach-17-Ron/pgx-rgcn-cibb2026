...
# Shaded region for pre-2020 (visual emphasis)
ax.axvspan(-0.5, 2.5, alpha=0.08, color=MUTED)

ax.set_title("Literature validation: 17.5% support rate over 190 drugs",
             fontsize=10, pad=8)
ax.set_xlabel("Publication decade", fontsize=10)

# Annotation OUTSIDE the plot at bottom
fig.text(0.5, -0.02, "45% of articles pre-date 2020 — wider date filter essential for PGx literature",
