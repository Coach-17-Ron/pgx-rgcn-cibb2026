"""
Plot 3: D4 SMILES stratification — THE HERO PLOT.

Story: Chemical structure availability dominates performance. Drugs with
SMILES achieve ~0.10 MRR; drugs without achieve ~0.04 MRR. This 5.5x gap
is larger than any methodological effect tested.
"""
...
ax.set_title("Chemical structure availability dominates cold-drug ranking\n"
             "(SMILES effect: +0.065 MRR = 5.5x larger than any methodological choice)",
             fontsize=10, pad=10)
