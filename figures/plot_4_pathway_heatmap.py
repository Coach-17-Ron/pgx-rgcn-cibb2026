"""
Plot 4: D5-Part 2 pathway enrichment across 12 configs.

Story: 10 PGx drug pathways FDR-significant across ALL 12 configurations.
"""
...
from plot_style import apply_style, HIGHLIGHT, LIGHT, DARK, save_figure
...
configs = [
    "def-42", "def-123", "def-2026",
    "amb-42", "amb-123", "amb-2026",
    "non-42", "non-123", "non-2026",
    "b0-42", "b0-123", "b0-2026",
]
...
ax.set_title("10 PGx drug pathways FDR-significant across ALL 12 configurations",
             fontsize=10, pad=10)
